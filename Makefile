...
ONDEWO_SURVEY_API_VERSION=1.1.0
...
GENERIC_RELEASE_NOTES="\n***************** \n\\\#\\\# Release ONDEWO SURVEY REPONAME Client ${ONDEWO_SURVEY_API_VERSION} \n \
	\n\\\#\\\#\\\# Improvements \n \
	* Tracking API Version ${ONDEWO_SURVEY_API_VERSION} \n"
...
# Build new code
	...
	git -C ${REPO_DIR} commit -m "API-Release: Preparing for Release ${ONDEWO_SURVEY_API_VERSION}"
	git -C ${REPO_DIR} push
